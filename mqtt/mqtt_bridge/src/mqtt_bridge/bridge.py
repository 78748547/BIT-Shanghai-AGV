...
def create_bridge(factory: Union[str, "Bridge"], msg_type: Union[str, Type[rospy.Message]], topic_from: str,
    ...
    #  by wsk 2023 add agvId
    # agvId = rospy.get_param("/agvId")
    # if(factory=="mqtt_bridge.bridge:MqttToRosBridge") and (topic_from[-1]=='/'):  
    #     topic_from+=agvId
    # if(factory=="mqtt_bridge.bridge:RosToMqttBridge") and (topic_to[-1]=='/'):  
    #     topic_to+=agvId    
    # rospy.loginfo(topic_to)    
